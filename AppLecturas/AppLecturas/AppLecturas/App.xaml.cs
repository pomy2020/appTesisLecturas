    ...
    public partial class App : Application,ILoginManager
    {
        ...
        public static Base.Database Database//crea la base de datos local
        {
            get
            {
                ...
                {
                    database = new Base.Database(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "baselocal2420.db3"));//creación de la base de datos local
                }
